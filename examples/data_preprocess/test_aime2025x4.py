...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='./data/aime2025x4')
    ...
    test_dataset = test_dataset.remove_columns(["year", "__index_level_0__"])

    print(len(test_dataset))

    num_repeats = 4
    test_dataset = datasets.concatenate_datasets([test_dataset] * num_repeats)

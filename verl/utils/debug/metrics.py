...
def calculate_debug_metrics(data: DataProto, use_sparse_and_dense_teacher: bool = False) -> dict: 
    """
    ...
    if not use_sparse_and_dense_teacher: 
        actor_old_log_probs = data.batch["old_log_probs"] 
    else: 
        actor_old_log_probs = data.batch["oldsparse_log_probs"] 

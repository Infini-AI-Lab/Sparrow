...
def compute_score(prompt_str, solution_str, ground_truth, format_score=0.0, full_score=1.) -> float:
    try:
        ...
        # print("ans_string {} ans_string type {} ground_truth {} ground_truth type {}".format(ans_string, type(ans_string), ground_truth, type(ground_truth))) 
        if do_print:
            print("\n" + "="*80)

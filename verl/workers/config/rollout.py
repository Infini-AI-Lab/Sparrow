...
class RolloutConfig(BaseConfig):
    ...
    sparse_rollout: bool = False 
    cuda_graph_turnon: bool = False 

    calculate_log_probs: bool = False
    
    log_probs_to_keep: int = 20
    enable_fast_toplogprobs_path: bool = False
    
    force_keep_model_name: Optional[str] = None
    
    rollout_model_update_every_nsteps: int = 1
    ...
    dense_filtering_overload: bool = False 

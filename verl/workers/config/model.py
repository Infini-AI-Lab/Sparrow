...
class HFModelConfig(BaseConfig):
    ...
    # sparse lora related 
    sparse_lora_rank: int = 0 
    sparse_lora_alpha: int = 16 
    sparse_target_modules: Optional[str] = "all-linear" 
    
    sparse_exclude_modules: Optional[str] = None 

    use_fused_kernels: bool = False
    fused_kernel_options: dict = field(default_factory=dict)

    architectures: Optional[list[str]] = None
    rolloutmodelpath: Optional[str] = None

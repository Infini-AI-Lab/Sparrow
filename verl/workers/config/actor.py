...
class ActorConfig(BaseConfig):
    ...
    tis_use_new_ckpt_debug: bool = False 
    sparse_tis_imp_ratio_cap: float = -1 
    ...
    use_logits_clipping: bool = False
    use_double_min_sample: bool = True
    log_probs_to_keep: int = 20
    double_min_upclip_ratio: float = 3.0
    double_min_apply_trust_region: bool = False
    double_min_use_latest_logits: bool = False
    generalized_double_min_acceptance_threshold: float = 1.0
    double_min_use_topk_renormalize: bool = True
    double_min_use_sequence_level_mask: bool = False
    double_min_sequence_level_mask_use_mean: bool = True 
    use_sparse_training: bool = False 
    bsa_kwargs_nsa_block_size: int = 16 
    bsa_kwargs_nsa_block_counts: int = 32 
    bsa_kwargs_window_offset: int = 0 
    double_min_use_legacy_style_loss: bool = False 
    debugging_dense_teacher: bool = False 
    dense_kl_loss: bool = False 
    dense_kl_loss_coef: float = 0.001 
    dense_kl_loss_type: str = "low_var_kl" 
    disable_policy_gradient: bool = False 
    debug_grad_flow: bool = False 
    lr_scale_factor: float = 5.0 
